                        ...
                        <Experiences
                            ...
                            jobs={[
                                ...
                                },
                                {
                                    ...
                                    text: ["As a Senior Web Developer at Forrit, I worked with multiple large scale household name clients, such as Microsoft Education, Lloyds of London, Macallan, Motorola, and more. Over the years I sucssessfully delivered several full scale website migrations into our in house solutions. Many projects required new functionality over time, from small to large component updates, to complete redesigns of client websites. "
                                        , "Collaborating with clients and colleagues was a vital part of my work, ensuring my knowledge was applied to help improve the performance and quality of the work being analysed. This often lead to smoother and more sucsessful outcomes for the client. "
                                        , "My role covered mny aspects from creating and maintaining responsive web pages, building accessible yet interactive user interfaces and features for all to use to WCAG standards, utilising differing front end frameworks best suited to the projects needs. I maintained the integrity of several project code bases, alongside managing deployments of new updates to clients public facing websites. I have developed several in house toolkit applications  at Forrit which aid across the service delivery teams in day to day functions. "]
                                },
                                {
                                    Company: "Inforgen",
